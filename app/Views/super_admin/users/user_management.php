                        ...
                        <?= csrf_field() ?>
                            ...
                            <div class="mb-3">
                                <select name="role" class="default-select  form-control wide" required>
                                    <option value="User" <?php echo !empty($user_list) && $user_list['role']=='User'?'selected':'';?>>Client User</option>
                                    <option value="Super_Admin" <?php echo !empty($user_list) && $user_list['role']=='Super_Admin'?'selected':'';?>>Admin</option>
                                </select>
                                <span style="color:red;"><?php echo !empty($validationErrors['role']) ? $validationErrors['role'] : ''; ?></span>
                            </div>
                            <div class="mb-3">
                                <input type="text" name="username" class="form-control input-default " placeholder="User ID" value="<?php echo !empty($user_list)?$user_list['username']:'';?>" required>
                            ...
                            <?php } ?>
                            <div class="mb-3">
                                <select name="shift" class="default-select  form-control wide" required>
                                    <option value="day" <?php echo !empty($user_list) && $user_list['shift']=='day'?'selected':'';?>>Day</option>
                                    <option value="night" <?php echo !empty($user_list) && $user_list['shift']=='night'?'selected':'';?>>Night</option>
                                </select>
                                <span style="color:red;"><?php echo !empty($validationErrors['role']) ? $validationErrors['role'] : ''; ?></span>
                            </div>
                            <div class="mb-3">
